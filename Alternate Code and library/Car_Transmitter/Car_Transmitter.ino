...
uint8_t receiverMacAddress[] = {0x10,0x06,0x1C,0x80,0x43,0x60};  //10:06:1C:82:02:80 //10:06:1C:80:43:60
...
void setup()
{
  ...
  peerInfo.ifidx = ESP_IF_WIFI_STA; // Set peer interface
...
void loop() 
{
  ...
  {  
    ...
    String inputData  = inputData + "values " + xAxisValue + "  " + yAxisValue;
